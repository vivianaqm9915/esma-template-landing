      ...
      <v-container :class="{ 'fixed-width': isDesktop }">
        ...
        <div class="user-menu">
          <hidden point="smDown">
            ...
            <v-btn :to="localePath(routerLink.hosting.login)" class="text-btn" variant="text">
              {{ $t('hostingLanding.header_login') }}
            </v-btn>
            <v-btn
              :to="localePath(routerLink.hosting.register)"
              color="secondary"
              class="button"
              variant="flat"
      ...
      <div class="navigation">
        <v-container class="fixed-width">
          <nav class="nav-menu">
            <v-btn
              v-if="invert"
              :to="localePath(routerLink.hosting.home)"
              class="icon"
              icon
            >
            ...
            <ul class="scrollactive-nav">
              ...
              <li>
                <v-btn
                  :to="localePath(routerLink.hosting.contact)"
                  variant="text"
