<template>
  ...
  >
    ...
    <v-list class="popover ocean-var">
      <div class="mode-menu">
        <v-list-subheader>{{ $t('profileLanding.header_theme') }}</v-list-subheader>
        <v-list-item>
          <div class="flex-menu">
            <span>
      ...
      <v-divider />
      <div class="lang-menu">
        <v-list-subheader>{{ $t('profileLanding.header_language') }}</v-list-subheader>
        <v-list-item
