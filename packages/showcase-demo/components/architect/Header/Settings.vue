<template>
  ...
  >
    ...
    <v-list class="popover ocean-var">
      <div class="mode-menu">
        <v-list-subheader>{{ $t('architectLanding.header_theme') }}</v-list-subheader>
        <v-list-item>
          <div class="flex-menu">
            <span>
              {{ $t('architectLanding.header_light') }}
            </span>
            <v-switch
              :model-value="isDark"
              class="switch-toggle"
            ...
            />
            <span>
              {{ $t('architectLanding.header_dark') }}
            </span>
          </div>
        </v-list-item>
      </div>
      <v-divider />
      <div class="lang-menu">
        <v-list-subheader>{{ $t('architectLanding.header_language') }}</v-list-subheader>
        <v-list-item
